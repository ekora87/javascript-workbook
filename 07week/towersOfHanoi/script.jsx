...
class TowersOfHanoi extends React.Component {
  ...
  render() {
    return (
      <div>
        <div data-stack="1" onClick={this.addBlock}>
          <div data-block="100" onClick={this.moveBlock}></div>
          <div data-block="75" onClick={this.moveBlock}></div>
          <div data-block="50" onClick={this.moveBlock}></div>
          <div data-block="25" onClick={this.moveBlock}></div>
        </div>
        <div data-stack="2" onClick={this.addBlock}>
        </div>
        <div data-stack="3" ref="stack3" onClick={this.addBlock}>
        </div>
      </div>
    );
  }
